...
<body class="container_registro">
  ...
  <main class="container_registro_main">
    <section class="container_registro_form">
      ...
      <form action="insertarusuario.php" method="post" class="registro_form" onsubmit="return validarFormularioRegistro()">
        <input type="text" name="nombre" autocomplete="off" class="input_form" placeholder="Nombre" id="nombre" required/>
        <input type="text" name="apellido" autocomplete="off" placeholder="Apellido" class="input_form" id="apellido" required/>
        ...
        <input type="date" name="fechaNacimiento" class="input_form" id="fechaNacimiento" required/>
        <select name="pais" id="pais" class="input_form form_select" required>
          <option value="" readonly>Seleccione un País</option>
          <option value="Argentina" selected>Argentina</option>
        </select>
        <input type="number" name="telefono" autocomplete="off" class="input_form" placeholder="Telefono" id="telefono" min="1000000" max="999999999999999" required />
        <input type="number" name="dni" autocomplete="off" class="input_form" placeholder="DNI" id="dni" min="1000000" max="99999999" required />
