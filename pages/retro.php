      ...
      <div class="container">
        ...
        <div class="image-index-destacados">
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_stick_lite.jpg" alt="consola_retro_stick_lite" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect2" href="#">
            <img src="../img/consola_retro_sup.jpg" alt="consola_retro_sup" />
            <h2 class="overlay">SIN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_arcade.jpg" alt="consola_retro_arcade" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_arcade_doble.jpg" alt="consola_retro_arcade_doble" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_apevtech.jpg" alt="consola_retro_apevtech" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_level_up.jpg" alt="consola_retro_level_up" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect2" href="#">
            <img src="../img/consola_retro_arcade_gold.jpg" alt="consola_retro_arcade_gold" />
            <h2 class="overlay">SIN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_tolueno.jpg" alt="consola_retro_tolueno" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/consola_retro_boy.jpg" alt="consola_retro_boy" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
        </div>
