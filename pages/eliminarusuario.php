...
<body>
    ...
    <main class="container_registro_main">
        <section class="container_registro_form">
            <div class="container">
                <h1 class="registro_form_titulo">Eliminar Usuario</h1>
                <div class="card">
                    <img src="../img/api.jpg" alt="img">
                    <div class="card-body">
                        <form action="eliminarusuario2.php" method="GET">

                            <label class="card" for="id_usuario">Id Usuario:</label>

                            <input class="card" type="number" id="id_usuario" name="id_usuario" required>

                            <input class="btn_card" type="submit" value="Eliminar Usuario" />
