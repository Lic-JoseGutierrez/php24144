...
<body>
  ...
  <main>
    <section id="fondo-index">
      ...
      <div class="container">
        <img src="../img/tecnologia.gif" alt="" />
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="image-index-destacados">
          <a class="hovereffect" href="#">
            <img src="../img/joystick_ps4.jpg" alt="joystick_ps4" />
          ...
          <a class="hovereffect" href="#">
            <img src="../img/auricular.jpg" alt="auricular" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
          ...
          <a class="hovereffect" href="#">
            <img src="../img/pc_gamer.jpg" alt="pc_gamer" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect2" href="#">
            <img src="../img/cargador_joystick.jpg" alt="cargador_joystick" />
            <h2 class="overlay">SIN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/volante.jpg" alt="volante" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
          <a class="hovereffect" href="#">
            <img src="../img/silla_gamer.jpg" alt="silla_gamer" />
            <h2 class="overlay">EN STOCK</h2>
          </a>
        </div>
