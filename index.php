...
<body>
  <header>
    <nav>
      <h3 class="animate__animated animate__shakeY">
        <a href="" class="link">🎮Insert-Coin</a>
      </h3>
      <ul>
        <li>
  ...
  <main>
    <section id="fondo-index">
      <div class="titulo">
        <h1>Compra juegos digitales<br />de forma fácil y segura</h1>
      </div>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="./img/fondo1.jpg" alt="First slide" />
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/fondo2.jpg" alt="Second slide" />
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/fondo3.jpg" alt="Third slide" />
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/fondo4.jpg" alt="fourth slide" />
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./img/fondo5.jpg" alt="fifth slide" />
            </div>
          </div>
    ...
    <section id="index-destacados">
      <div class="container">
        <div class="image-index-destacados">
          <a href="pages/playstation.php">
            <img src="img/playstation.gif" alt="playstation" />
          </a>
          <a href="pages/xbox.php">
            <img src="img/xbox.gif" alt="xbox" />
          </a>
          <a href="pages/nintendo.php">
            <img src="img/nintendo.gif" alt="nintendo" />
          </a>
          <a href="pages/pc.php">
            <img src="img/pc.webp" alt="pc" />
          </a>
          <a href="pages/retro.php">
            <img src="img/retro.gif" alt="retro" />
          </a>
          <a href="pages/tecnologia.php">
            <img src="img/tecnologia.gif" alt="tecnologia" />
          </a>
        </div>
      </div>
    </section>
